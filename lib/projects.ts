...
content: "https://www.figma.com/embed?embed_host=share&url=https://www.figma.com/proto/WY8wFLQpycygkNHo1oqA5z/Family-Tree-Web-Application?node-id=11-1415&scaling=scale-down-width&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=113%3A324"
  ...
  },
  {
    ...
    description: [
      ...
      "It is not a traditional CAD tool, but a creative modeling companion that understands language, imagery, and intent. Suzanne lets users describe, sketch, or upload a photo to generate and edit 3D models in real time.",
      "Every object can be modified through natural commands, refined procedurally, and exported instantly.",
    ],
    features: [
      "Text-to-Model Generation using Claude and OpenSCAD",
      "Image-to-Model Conversion with Hunyuan diffusion model",
      "Conversational Editing through natural language commands",
      "Interactive Visualization with Three.js and WebXR support",
      "Real-time STL generation through WebAssembly",
  ...
  },
  {
    ...
    shortDescription:
      "A memory-augmented personal AI assistant that connects to your tools, understands your routines, and gets things done — like a real human, but faster.",
    description: [
      "Zyra is a personal AI agent designed to alleviate the overwhelm of managing emails, meetings, reminders, and tasks.",
      "It integrates with tools like Gmail, Calendar, Notion, and Google Docs to streamline productivity.",
      "Zyra utilizes a dynamic system prompt generation pipeline powered by Supabase as a memory database, storing various types of memory to learn user preferences and adapt accordingly.",
      "The frontend is built using Bolt, enabling real-time voice interaction through LiveKit and ElevenLabs, while execution capabilities are powered by Composio's API suite.",
    ],
    features: [
      "Memory-augmented AI with Supabase database",
      "Integration with Gmail, Calendar, Notion, and Google Docs",
      "Real-time voice interaction with LiveKit and ElevenLabs",
      "Dynamic system prompt generation",
      "Short-term, episodic, semantic, and VIT memory storage",
